...
function createDescriptionLine() {
  ...
  newLineContainer.className = "input-group mb-3";

  const newLineButton1Container = document.createElement("div");
  newLineButton1Container.className = "input-group-prepend w-25";

  const newLineButton1 = document.createElement("button");
  newLineButton1.className = "btn btn-secondary w-100";
  newLineButton1.type = "button";
  newLineButton1.id = "button-addon1";
  newLineButton1.disabled = "true"
  newLineButton1.textContent = `Work Line ${workLine.length + 1}`

  const newLineInput1 = document.createElement("input");
  newLineInput1.type = "text";
  newLineInput1.className = "form-control workLine";
  newLineInput1.placeholder = "...";

  const newLineButton2Container = document.createElement("div");
  newLineButton2Container.className = "input-group-prepend w-25";

  const newLineButton2 = document.createElement("button");
  newLineButton2.className = "btn btn-secondary w-100";
  newLineButton2.type = "button";
  newLineButton2.id = "button-addon1";
  newLineButton2.disabled = "true"
  newLineButton2.textContent = "Amount"

  const newLineInput2 = document.createElement("input");
  newLineInput2.type = "text";
  newLineInput2.className = "form-control workLineAmount";
  newLineInput2.placeholder = "0.00";

  newLineButton1Container.appendChild(newLineButton1);
  newLineButton2Container.appendChild(newLineButton2);
  newLineContainer.appendChild(newLineButton1Container);
  newLineContainer.appendChild(newLineInput1);
  newLineContainer.appendChild(newLineButton2Container);
  newLineContainer.appendChild(newLineInput2);

  lastWorkLine.parentNode.insertBefore(newLineContainer, lastWorkLine.nextSibling);
}
...
function findTotal(event){
  ...
  total.textContent = workLineTotal
}
...
function genPDF() {
  ...
  doc.text(total.textContent, 170, 185);
  doc.text("-", 170, 190);
  doc.text("-", 170, 195);
  doc.text("-", 170, 200);
  doc.text("-", 170, 205);
  ...
  doc.text("$", 168, 210);
  doc.text(total.textContent, 170, 210);
